...
- How a user interacts (e.g. chat UI, asking for flashcards, requesting quiz)
- Screenshots or GIFs (if available)
- Example prompts & sample responses  
- Any caveats, limitations, or expected behavior  
...
4. Push to your branch: `git push origin feature/foo-bar`  
5. Open a pull request describing your changes  
6. I will review & merge (or provide feedback)  

Please adhere to code style, document new features, and test thoroughly.
